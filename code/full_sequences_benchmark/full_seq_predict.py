...
np.save(f'{results_path}/n_bilstm_att.npy', np.array(n_preds_list, dtype=object), allow_pickle=True)
np.save(f'{results_path}/c_bilstm_att.npy', np.array(c_preds_list, dtype=object), allow_pickle=True)
